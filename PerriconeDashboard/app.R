...
IDC_update_date='from IDC shipment reports (updated @ 2/15/2020)'
financial_report_date='from financial reports (updated @ 2/13/2020)'
lag_clarification_date='Jan S&OP for Lag0,  Dec S&OP for Lag1'

############################## THRESHOLD #################################

SKU_list <-unique(read_excel("SmartList BOM Extract.xlsx", sheet=1,col_types='text')$`Item_Number_FGI`)

franchise_list <- c("Cold Plasma","HP Classics"="High Potency Classics","No Makeup"="No Makeup Skincare","VC Ester"="Vitamin C Ester","Supplements","Neuropeptide","Essential Fx"="Essential Fx Acyl Glutathione","Hypoallergenic","Mixed Franchise","Acne","Masks","Hypo CBD"="Hypoallergenic CBD","No:Rinse","Heritage","Intensive Pore","Pre:Empt","Mens","H2 EE"="H2 Elemental Energy","Re:Firm","Thio:Plex")

franchise_vector <-append(franchise_list,"All Franchises", after=0)
acct_vector <- c("Company","Int'l"="APAC+LA","Amazon","Bloomingdales","Costco","Dillard's","EC Scott","GR"="Guthy Renker","L&T"="Lord & Taylor","Macy's","NM"="Neiman Marcus","Nordstrom","Other.com","PMD.com","QVC","Sephora","TSC","UK","ULTA"="Ulta","Zulily",'Liquidators'='Retail - Other')
                            ...
                            sidebarLayout(
                              sidebarPanel(width =3,
                                           ...
                                           div(style="display: inline-block;",radioButtons("acct_variable1",h4(p(strong("Choose Account:"))),inline=TRUE,
                                                                                           choices=list("Company","Int'l"="APAC+LA","Amazon","Bloomingdales","Costco","Dillard's","EC Scott","GR"="Guthy Renker","L&T"="Lord & Taylor","Macy's","NM"="Neiman Marcus","Nordstrom","Other.com","PMD.com","QVC","Sephora","TSC","UK","ULTA"="Ulta","Zulily","NCO/Liquidators")
                                           ...
                                           selectInput("daterange_variable1",h4(p(strong("Date Range:"))),
                                                       c("Feb 2020 (in process)","Jan 2020","Dec 2019","Nov 2019"),
                                                       selected = c("Feb 2020 (in process)")
                                           ),
